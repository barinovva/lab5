...
import com.test_classes.InterfaceImpl;
import com.test_classes.InterfaceTest;
import com.test_classes.MyClass;
...
class InjectorTest {
    ...
    public void testProp() throws IOException, ClassNotFoundException, NoSuchMethodException,
        ...
        String x = properties.getProperty("com.interfaces.Controller");
